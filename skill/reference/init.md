...
STOP and call the `ask_user_question` tool to clarify. Ask only about material gaps the repository and original request do not answer with strong evidence.
